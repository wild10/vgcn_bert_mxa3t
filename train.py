...
parser.add_argument('--ds', type=str, default='mx')
...
dropout_rate = 0.1#0.2  #0.5 # Dropout rate (1 - keep probability).
...
print(' train examples 0 : ', train_examples[0].text_a)
print('train example 0 label:', train_examples[0].label)
...
print("weight: ", train_classes_weight)
...
print("**Valid macro F1: %.3f at %d epoch."%(100*perform_metrics_prev,valid_f1_best_epoch))
print("**Test macro F1 when valid best: %.3f"%(100*test_f1_when_valid_best))
