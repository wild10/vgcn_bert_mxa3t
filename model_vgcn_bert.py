...
class VocabGraphConvolution(nn.Module):
    ...
    """
    # dropout_rate = 0.2
    def __init__(self,voc_dim, num_adj, hid_dim, out_dim, dropout_rate=0.1):
...
class Pretrain_VGCN(nn.Module):
    ...
    """
    #dropout_rate=0.2
    def __init__(self, word_emb, word_emb_dim, gcn_adj_dim, gcn_adj_num, gcn_embedding_dim, num_labels,dropout_rate=0.1):
